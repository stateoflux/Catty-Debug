...
class R2d2Test < ActiveSupport::TestCase
  test "should create r2d2" do
    ...
    r2d2.instance = 0 
    r2d2.part_number = "08-0674-05" 
    r2d2.refdes = "U100"
    r2d2.assembly = assemblies(:ringar_5)
    add_memories(r2d2)
